...
def upgrade() -> None:
    ...
    op.alter_column(
        "repo_embeddings", "embedding", existing_type=Vector(384), type_=Vector(1536), existing_nullable=True
    )
...
def downgrade() -> None:
    ...
    op.alter_column(
        "repo_embeddings", "embedding", existing_type=Vector(1536), type_=Vector(384), existing_nullable=True
    )
