    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-background px-4">
        <Card className="max-w-sm p-8 text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">We sent a verification link to <strong>{email}</strong>. Click the link to activate your account.</p>
          <Link href="/signin" className="mt-6 inline-block text-sm font-medium text-amber-600 hover:text-amber-700">Back to Sign In</Link>
        </Card>
      </div>
    );
  }
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm">
        ...
        <Card className="p-6">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Start translating code for free.</p>

          <div className="mt-6 space-y-2">
            <Button variant="outline" className="w-full gap-2 text-sm" onClick={handleGoogle}>
            ...
            <Button variant="outline" className="w-full gap-2 text-sm" onClick={handleGitHub}>
