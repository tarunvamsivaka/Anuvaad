        ...
        <Card className="p-6">
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <div>
              ...
              <Input type="password" placeholder="Min. 8 characters" className="mt-1 text-sm" />
            </div>
            <Button type="submit" className="w-full bg-amber-600 hover:bg-amber-700 text-sm">Create Account</Button>
          </form>
