...
const faqs = [
  ...
  { q: "Can I use Anuvaad for free?", a: "Yes! The free plan includes 25 translations per day, all 3 modes, and full export capabilities. Guests (without an account) get 5 trial translations. No credit card required." },
