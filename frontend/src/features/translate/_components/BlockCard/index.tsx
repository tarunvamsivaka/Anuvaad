...
// ⚡ Bolt: Added React.memo to prevent unnecessary re-renders during SSE streaming and state updates.
// Combined with stable callbacks, this significantly reduces render time for long output blocks.
