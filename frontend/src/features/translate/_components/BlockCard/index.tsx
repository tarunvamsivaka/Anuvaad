...
// Wrapped in React.memo to prevent unnecessary re-renders during state updates in the parent component.
// Framer Motion and Monaco Editor instances inside make this component computationally expensive.
