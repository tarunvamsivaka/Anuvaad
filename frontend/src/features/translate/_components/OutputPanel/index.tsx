...
export function OutputPanel({
  ...
  // ⚡ Bolt Optimization:
  // Memoize full text derivations to prevent O(N) array mapping and string concatenation
  // on every render, especially critical since this component subscribes to the rapidly
  // changing `useTranslationStore` during SSE streaming.
