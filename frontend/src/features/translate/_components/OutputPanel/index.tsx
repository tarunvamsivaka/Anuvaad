...
export function OutputPanel({
  ...
  // ⚡ Bolt Optimization: Memoize expensive string concatenations.
  // Since OutputPanel subscribes to the entire useTranslationStore, it re-renders
  // on every streamText update (multiple times per second during streaming).
  // Without useMemo, this O(N) array mapping runs on every render unnecessarily.
                ...
                <div className="h-full w-full p-2 flex flex-col">
                  ...
                  <div className="flex-1 w-full overflow-hidden">
                    <DiffEditor
                      ...
                      modified={diffOriginalCode ? input : (fullCodeText || fullEnglishText)}
                      language={monacoLang}
                      theme={isDark ? "vs-dark" : "light"}
                      options={{
                        ...monacoOptions,
